...
class Store(metaclass=ABCMeta):
    ...
    def save(
        ...
        config_path : Path, optional
            the path to save the config file to, defaults to `~/.frametree/stores.yaml`
        """
    ...
    def load(
        ...
        config_path : Path, optional
            path to the config file, defaults to `~/.frametree/stores.yaml`
        **kwargs
    ...
    def load_saved_configs(
        ...
        ----------
        config_path : Path, optional
            the file-system path to the configuration, by default uses one in ~/.frametree
