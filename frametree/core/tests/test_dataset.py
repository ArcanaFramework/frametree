...
def test_dataset_pickle(dataset: Grid, tmp_dir: Path):
...
def test_dataset_in_workflow_pickle(dataset: Grid, tmp_dir: Path):
...
@mark.task
@mark.annotate({"a": int, "b": int, "dataset": Grid, "return": {"c": int}})
