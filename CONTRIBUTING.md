# Contributing to FrameTree

\[adapted from the [Pydra contribution guide](https://github.com/nipype/pydra/blob/master/CONTRIBUTING.md)\]

Welcome to the FrameTree repository! We're excited you're here and want to contribute.
...
to the AUTHORS file and the `__authors__` list in `frametree/__about__.py`.
...
We appreciate all improvement to the FrameTree code or documentation.
...
This allows other members of the FrameTree development team to confirm
...
**ii. [Fork][link_fork] the [FrameTree repository][link_FrameTree] to your profile**

This is now your own unique copy of the FrameTree repository.
Changes here won't affect anyone else's work, so it's a safe space to explore edits to the code!

**iii. [Clone][link_clone] the repository to your local machine**

You can clone your FrameTree repository (from your fork!) in order to create a local copy of the code on your machine.

(Make sure to keep your fork up to date with the original FrameTree repository.
...
**iv. Install FrameTree on your machine**

To install your version of FrameTree, and the dependencies needed for development,
in your Python environment (Python 3.7 or higher), run `pip install -e ".[dev]"`
from your local FrameTree directory.

In order to check if everything is working correctly, run the tests
using [pytest](https://docs.pytest.org/en/latest/), e.g. `pytest -vs frametree`
...
[link_FrameTree]: https://github.com/australian-imaging-service/frametree
[link_signupinstructions]: https://help.github.com/articles/signing-up-for-a-new-github-account
[link_new_issues]: https://github.com/australian-imaging-service/FrameTree/issues/new/choose
[link_doc_issues]: https://github.com/australian-imaging-service/FrameTree/issues/new?assignees=&labels=documentation&template=documentation.md&title=
...
[link_zenodo]: https://github.com/australian-imaging-service/frametree/master/.zenodo.json
