...
..     import json
..     from frametree.xnat.deploy import XnatCommand
...
itself into the Docker image within an Anaconda_ environment named "frametree". Therefore,
...
.. code-block:: console
    ...
    $ frametree deploy make-app xnat:XnatApp 'your-pipeline-config.yml'
...
.. code-block:: console
    ...
    $ frametree deploy make-app xnat:XnatApp 'config-root-dir'
...
.. code-block:: console
    ...
    $ frametree deploy test ./fast.yml ./fast-data
...
directory to ``frametree deploy test`` instead of the path to the YAML_ config
...
.. code-block:: console
    ...
    $ frametree deploy test ./mri ./mri-data --output test-results.json
    ...E..F..
...
.. code-block:: console
    ...
    $ frametree deploy docs <path-to-yaml-or-directory> <docs-output-dir>
